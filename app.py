...
import re
from main import start_quiz as start_quiz_main
os.environ["GEMINI_API_KEY"] ="AIzaSyDrQtrws0tl_9K3ZocgUhtPSt8-UdajPC0"
app = Flask(__name__)
...
def start_quiz():
    ...
    score = start_quiz_main(username)
    return jsonify({'status': 'Quiz completed', 'username': username, 'score': score})
...
def generate_quiz_with_gemini(text):
    ...
    prompt = f"""
        Create exactly 10 hard questions with 4 multiple-choices from the following text in English.
